...
interface RidePopupPanelProps{
    ride?: Ride
    setRidePopupPanel:React.Dispatch<SetStateAction<boolean>>;
    setConfirmRidePopupPanel:React.Dispatch<React.SetStateAction<boolean>>;
    confirmRide: ()=>Promise<void>;
}


const RidePopUp = (props:RidePopupPanelProps) => {
  return (
    <div>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='mt-5 w-full '>
                    {props.ride?.status === "pending" && (
                        ...
                        }} className=' bg-green-600 w-full text-white font-semibold p-2 px-10 rounded-lg'>Accepted</button>
