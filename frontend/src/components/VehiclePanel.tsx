...
const VehiclePanel = ({ setVehiclePanel, setConfirmedRidePanel }: VehiclePanelProps) => {
  return (
    <>
      ...
      <div onClick={()=>setConfirmedRidePanel(true)} className="flex w-full mb-5  gap-2 p-1  items-center justify-between border-2 rounded-2xl border-gray-100 active:border-black ">
        ...
        <h2 className="text-sm font-semibold">Rs. 193.20</h2>
      </div>
      <div onClick={()=>setConfirmedRidePanel(true)} className="flex w-full mb-5  gap-2 p-1  items-center justify-between border-2 rounded-2xl border-gray-100 active:border-black ">
        ...
        <h2 className="text-sm font-semibold">Rs. 65.20</h2>
      </div>
      <div onClick={()=>setConfirmedRidePanel(true)} className="flex w-full mb-5 p-1  gap-2  items-center justify-between border-2 border-gray-100 active:border-black  rounded-2xl ">
        ...
        <h2 className="text-sm font-semibold">Rs. 118.65</h2>
      </div>
    </>
  );
};
